...
class Mmr(Strategy):
    ...
    def _next(self) -> Node | None:
        ...
        selected_node.extra_metadata["_redundancy"] = selected.weighted_redundancy / self._lambda_mult_complement
        ...
        if self._candidate_embeddings.shape[0] > 0:
            ...
            for index, candidate in enumerate(self._candidates):
                candidate.update_redundancy(self._lambda_mult_complement * similarity[index][0])
